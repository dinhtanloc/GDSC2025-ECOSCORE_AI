...
class SDGAgent:
    ...
    def __init__(self, llm: str, llm_temperature: float, tools ) -> None:
        ...
        self.examples = [
            HumanMessage(content="Đánh giá công ty VNG theo khía cạnh Environmental"),
            AIMessage(content=(
            ...
            HumanMessage(content="Phân tích ESG xã hội của CTCP MWG"),
            AIMessage(content=(
            ...
            HumanMessage(content="Tôi cần báo cáo ESG Governance cho mã FPT"),
            AIMessage(content=(
